// import Chacha20 from './chacha20-original';
// import Poly1305 from './poly1305';
const Chacha20 = require( './chacha20-original');
const Poly1305 = require( './poly1305-original');
...
function chacha20_block_test() {
  ...
  for (var i = 0; i < testVectors.length; i++) {
    ...
    var ctx = new Chacha20.Chacha20(key, nonce, counter);
...
function poly1305_test() {
  ...
  for (var i = 0; i < testVectors.length; i++) {
    ...
    var out = Poly1305.poly1305_auth(input, input.length, key);

    if (Poly1305.poly1305_verify(expected, out) !== 1) {
      console.log('error: ', i);
      console.log('want:\n', expected.join(' '));
      console.log('got :\n', out.join(' '), '\n');
    } else {
...
function aead_test1() {
  ...
  for (var i = 0; i < testVectors.length; i++) {
    ...
    var ret = Poly1305.aead_encrypt(key, nonce, plaintext, aad);
...
function aead_test2() {
  ...
  for (var i = 0; i < testVectors.length; i++) {
    ...
    console.log('momce[0]', aad[0])
    console.log('noce', typeof aad[0])

    var ret = Poly1305.aead_encrypt(key, nonce, plaintext, aad);

    console.log('retttt',ret[0])
    console.log('retttt',ret[1])
